...
public class PaymentController {
    ...
    public ResponseEntity<?> vnpayCallback(@RequestParam Map<String, String> queryParams) {
        ...
        if ("00".equals(responseCode)) {
            ...
            try {
                String subject = "[TruyenHay] Nâng cấp Premium thành công!";
        ...
        String redirectUrl = frontendUrl + "/?status=" + (transaction.getStatus() == Transaction.TransactionStatus.SUCCESS ? "success" : "failed");
    ...
    public ResponseEntity<?> createMomoUrl(@RequestParam Long packageId) throws Exception {
        ...
        String orderInfo = "Thanh toan truyen hay gói " + pkg.getName();
